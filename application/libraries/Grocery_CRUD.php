...
class grocery_CRUD_Layout extends grocery_CRUD_Model_Driver
{
	...
	protected function get_datetime_input($field_info,$value)
	{
		...
		// Change datetimepicker to here
		$this->set_css('node_modules/gentelella/vendors/bootstrap-daterangepicker/daterangepicker.css');
		$this->set_js_lib('node_modules/gentelella/vendors/moment/moment.js');
		$this->set_js_lib('node_modules/gentelella/vendors/bootstrap-daterangepicker/daterangepicker.js');
	...
	protected function get_dropdown_input($field_info,$value)
	{
		...
		$input = "<select id='field-{$field_info->name}' name='{$field_info->name}' class='chosen-select' style='min-width:200px;' data-placeholder='".$select_title."'>";
	...
	protected function get_upload_file_input($field_info, $value)
	{
		...
		$input .= "<a href='javascript:void(0)' id='delete_$unique' class='btn btn-default btn-danger'>".ucfirst($this->l('form_upload_delete'))."</a> ";
