...
// $config['crumb_divider'] = '<span class="divider"><i class="fa fa-angle-double-right"  aria-hidden="true"></i></span>';
$config['crumb_divider'] = '<span class="divider"><img class="bc" src="assets/img/bc.png"></span>';
